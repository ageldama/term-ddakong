...
get_current_hangeul_automata_status (void)
{
...
CHOJUNGJONG
__hangeul_const_chojungjong_nul (void) { return CHOJUNGJONG_NUL; }

CHOJUNGJONG
__hangeul_const_choseong (void) { return CHOSEONG; }

CHOJUNGJONG
__hangeul_const_jungseong (void) { return JUNGSEONG; }

CHOJUNGJONG
__hangeul_const_jongseong (void) { return JONGSEONG; }

CHOJUNGJONG
__hangeul_const_moeum (void) { return MOEUM; }

CHOJUNGJONG
__hangeul_const_jaeum (void) { return JAEUM; }

hangeul_automata_status *
__hangeul_automata_status__new (void)
{
  hangeul_automata_status *p_status = NULL;
  p_status
      = (hangeul_automata_status *)malloc (sizeof (hangeul_automata_status));
  return p_status;
}

void
__hangeul_automata_status__delete (hangeul_automata_status *p_status)
{
  if (p_status != NULL)
    {
      free (p_status);
...
CHOJUNGJONG
__hangeul_automata_status__get_stage (hangeul_automata_status *p_status)
{
...
void
__hangeul_automata_status__set_stage (hangeul_automata_status *p_status,
...
BYTE
__hangeul_automata_status__get_prev_ch (hangeul_automata_status *p_status)
{
  assert (p_status != NULL);
...
void
__hangeul_automata_status__set_prev_ch (hangeul_automata_status *p_status,
                                        const BYTE ch)
{
  assert (p_status != NULL);
  p_status->prev_ch = ch;
...
BYTE
__hangeul_automata_status__get_cho (hangeul_automata_status *p_status)
{
  assert (p_status != NULL);
  return p_status->cho;
}
...
void
__hangeul_automata_status__set_cho (hangeul_automata_status *p_status,
                                    const BYTE cho)
{
  assert (p_status != NULL);
  p_status->cho = cho;
...
BYTE
__hangeul_automata_status__get_jung (hangeul_automata_status *p_status)
{
  assert (p_status != NULL);
...
void
__hangeul_automata_status__set_jung (hangeul_automata_status *p_status,
                                     const BYTE jung)
{
  assert (p_status != NULL);
  p_status->jung = jung;
...
BYTE
__hangeul_automata_status__get_jong (hangeul_automata_status *p_status)
{
  assert (p_status != NULL);
...
void
__hangeul_automata_status__set_jong (hangeul_automata_status *p_status,
                                     const BYTE jong)
{
  assert (p_status != NULL);
  p_status->jong = jong;
...
plugin_func_t *
get_plugin_funcs (void)
{
  return (plugin_func_t *)plugin_funcs;
}

ssize_t
get_plugin_funcs_len (void)
{
...
int
__get_verbose_flag (void)
{
  return verbose_flag;
}

void
__set_verbose_flag (const int verbose)
{
  verbose_flag = verbose;
}

char *
__get_keylog_filename (void)
{
  return keylog_filename;
}

char *
__get_default_keylog_filename (void)
{
  return default_keylog_filename;
}

pid_t
__get_child_pid (void)
{
  return child_pid;
}
...
char *
__get_plugin_dll_filename (void)
{
...
const ssize_t plugin_funcs_len
    = sizeof (plugin_funcs) / sizeof (plugin_func_t);

...
int
luab__input_handler_get_current_handle_input_fn (lua_State *L)
{
  /*
    () => (cfn | lfn)
...
int
luab__input_handler_set_current_handle_input_fn (lua_State *L)
{
  /* (fn) => () */
...
void
luab__input_handler_handle_input (void *p_status, const int fd_keyin,
                                  const int fd_child, char *buf,
